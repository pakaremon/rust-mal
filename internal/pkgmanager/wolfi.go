...
type wolfiPackageInfoJSON struct {
	Info struct {
...
func getWolfiLatest(pkg string) (string, error) {
	...
	var packageInfo wolfiPackageInfoJSON
...
func getWolfiArchiveURL(pkgName, version string) (string, error) {
...
var wolfiPkgManager = PkgManager{
	ecosystem:       pkgecosystem.Wolfi,
	latestVersion:   getWolfiLatest,
	archiveURL:      getWolfiArchiveURL,
